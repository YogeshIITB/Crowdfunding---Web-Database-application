...
function UsersTableName()
{
	...
	return $connection->addTableWrappers("public.users");
}
...
class tDAL
{
	var $tblTrialRun_at_localhost_public_donation;
	var $tblTrialRun_at_localhost_public_project;
	var $tblTrialRun_at_localhost_public_users;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "donation", "varname" => "TrialRun_at_localhost_public_donation", "altvarname" => "donation", "connId" => "TrialRun_at_localhost", "schema" => "public", "connName" => "TrialRun at localhost");
		$this->lstTables[] = array("name" => "project", "varname" => "TrialRun_at_localhost_public_project", "altvarname" => "project", "connId" => "TrialRun_at_localhost", "schema" => "public", "connName" => "TrialRun at localhost");
		$this->lstTables[] = array("name" => "users", "varname" => "TrialRun_at_localhost_public_users", "altvarname" => "users", "connId" => "TrialRun_at_localhost", "schema" => "public", "connName" => "TrialRun at localhost");
	}
