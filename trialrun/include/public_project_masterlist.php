<?php
function DisplayMasterTableInfo_public_project($params)
{
	global $cman;
	...
	$layout = GetPageLayout("public_project", 'masterlist');
	if( $layout )
		$xt->assign("pageattrs", 'class="'.$layout->style." page-".$layout->name.'"');
	
	$xt->displayPartial(GetTemplateName("public_project", "masterlist"));
}
