<?php
function DisplayMasterTableInfo_public_users($params)
{
	global $cman;
	...
	$layout = GetPageLayout("public_users", 'masterlist');
	if( $layout )
		$xt->assign("pageattrs", 'class="'.$layout->style." page-".$layout->name.'"');
	
	$xt->displayPartial(GetTemplateName("public_users", "masterlist"));
}
