...
$layout = new TLayout("list6", "ExtravaganzaOffice", "MobileOffice");
$layout->version = 2;
...
$page_layouts["public_donation_list"] = $layout;
...
$layout = new TLayout("masterlist", "ExtravaganzaOffice", "MobileOffice");
$layout->version = 2;
...
$page_layouts["public_users_masterlist"] = $layout;
...
$layout->blocks["bare"][] = "mastergrid";
$page_layouts["public_project_masterlist"] = $layout;
