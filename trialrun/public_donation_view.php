...
$layout = new TLayout("view2", "ExtravaganzaOffice", "MobileOffice");
$layout->version = 2;
...
$page_layouts["public_donation_view"] = $layout;
...
$keys = array();
$keys["time"] = postvalue("editid1");
$keys["donor"] = postvalue("editid2");
$keys["project"] = postvalue("editid3");
