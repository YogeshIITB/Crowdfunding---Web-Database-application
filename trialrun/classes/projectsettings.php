...
class ProjectSettings
{
	...
	*/
	...
	{
		return new ProjectSettings("public.users", PAGE_LIST);
	}
...
function GetTableURL($table = "")
{
	...
	if(!$table)
		$table=$strTableName;
	if("public.donation" == $table) 
		return "public_donation";
	if("public.users" == $table) 
		return "public_users";
	if("public.project" == $table) 
...
{	
	...
	if(!$shortTName)
		return false;
	if("public_donation" == $shortTName) 
		return "public.donation";
	if("public_users" == $shortTName) 
		return "public.users";
	if("public_project" == $shortTName) 
