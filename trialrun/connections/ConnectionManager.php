...
class ConnectionManager
{
	...
	{
		return $this->byId( "TrialRun_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 4;
		$data["connId"] = "TrialRun_at_localhost";
		$data["connName"] = "TrialRun at localhost";
		$data["connStringType"] = "postgre";
		$data["connectionString"] = "postgre;localhost;postgres;123;;TrialRun;;1"; //currently unused
		
		$this->_connectionsIdByName["TrialRun at localhost"] = "TrialRun_at_localhost";
		...
		$data["connInfo"][2] = "123";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "TrialRun";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "Driver={PostgreSQL Unicode};Server=localhost;Database=TrialRun;Uid=postgres;Pwd=123;";
		$connectionsData["TrialRun_at_localhost"] = $data;
	...
	protected function _setTablesConnectionIds()
	{
		...
		$connectionsIds["public.donation"] = "TrialRun_at_localhost";
		$connectionsIds["public.users"] = "TrialRun_at_localhost";
		$connectionsIds["public.project"] = "TrialRun_at_localhost";
